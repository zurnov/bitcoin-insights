...
public interface UserRoleRepository extends JpaRepository<UserRole, Long> {
    ...
    @Query("SELECT new com.zurnov.bitcoin.insights.domain.entity.UserRoleDetailed(u.userId, u.username, r.roleName, r.description) " +
    ...
    List<UserRoleDetailed> getUserRolesDetailed(@Param("roleId") Long roleId);
